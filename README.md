...
Due to [SwiftPM dependency resolution rules](https://www.pointfree.co/blog/posts/116-being-a-good-citizen-in-the-land-of-swiftsyntax), this package also supports versions since `602`, with the following considerations:

### Versions older than [`603`](https://swiftpackageindex.com/swiftlang/swift-syntax/603.0.1/documentation/swiftsyntax)
